...
- The file-based membership handoff (`TEAM_MEMBERSHIP_FILE`) from this PR was kept as-is even though caching is gone — it works fine as a plain step-to-step transport and reverting it back to a step output isn't worth the churn.
